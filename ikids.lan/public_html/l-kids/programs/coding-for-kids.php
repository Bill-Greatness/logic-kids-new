...
<head>
    ...
    <title>Logic Kids - Coding for Kids</title>
...
<body>
    ...
    <br/>
    <br/>
<h3 class="ui header">Coding for kids - Logic Kids</h3>

<div class="ui segment placeholder" style='padding:0'>
        <img src="../../images/coding-club-logic-kids.jpg" alt="" class="ui image" height='300px' width='100%'>
    </div>
    ...
    <div class="column">
        ...
        <h3 class="ui icon header">
            ...
            <div class="content">
                Typing Lessons
                <div class="sub header">Practical Lesson for absolute beginners.</div>
            </div>
        </h3>
    </div>
        ...
        <h3 class="ui icon header">
                ...
                <div class="content">
                Scratch Coding
                    <div class="sub header">Creating Games, animations and Stories with Scratch</div>
                </div>
            </h3>
        </div>
        ...
        <div class="column">
            <h3 class="ui icon header">
                ...
                HTML, CSS and JavaScript
                    <div class="sub header">Website development with real world examples</div>
                </div>
            </h3>
        </div>
        ...
        <h3 class="ui icon header">
                ...
                <div class="content">
                    Python Programming
                    <div class="sub header">Introduction to Software development</div>
                </div>
            </h3>
        </div>
