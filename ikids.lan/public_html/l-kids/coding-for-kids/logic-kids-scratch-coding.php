...
<head>
    ...
    <title>Logic Kids - Scratch Coding for Kids   </title>
...
<body>
    ...
    <div class="ui text container">
        <div class="ui grid five column stackable">
            ...
            <div class="column">
                <img src="https://picsum.photos/id/34/600/400" alt="A Project Image" class='ui image rounded'>
            </div>
            ...
            <div class="column">
                <img src="https://picsum.photos/id/36/600/400" alt="A Project Image" class='ui image rounded'>
            </div>

            <div class="column">
                <img src="https://picsum.photos/id/337/600/400" alt="A Project Image" class='ui image rounded'>
            </div>
        </div>
    </div>

    <!-- <h3 class="ui header">Comments By Participants</h3>
    <p class="ui container">Lorem ipsum dolor sit amet consectetur adipisicing elit. In id enim reiciendis. Dignissimos, fuga? Eum architecto vel quam quibusdam asperiores sit magnam voluptas! Cumque excepturi nobis, obcaecati deleniti quidem libero sapiente aliquam consequuntur harum similique soluta ipsum facilis minima tenetur qui voluptatem illo vel, repudiandae officiis! Dolores atque quos at facilis. Odit harum laborum voluptatum.</p> -->
